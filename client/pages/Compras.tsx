...
export default function Compras() {
  ...
  const shoppingList: ShoppingItem[] = [
    {
      ...
      checked: false,
      alternatives: [
        { name: "Peito de Frango Congelado", price: 18.9, savings: 6.0 },
        { name: "Coxa e Sobrecoxa sem pele", price: 16.9, savings: 8.0 },
      ],
    },
    {
      id: "2",
      ...
      importance: "essential",
      checked: true,
      alternatives: [{ name: "Ovos de granja", price: 15.9, savings: 2.1 }],
    },
    {
      id: "3",
      ...
      checked: false,
      alternatives: [
        { name: "Arroz Integral a granel", price: 9.8, savings: 3.0 },
      ],
    },
    {
      id: "4",
    ...
    },
    {
      ...
      checked: false,
      alternatives: [
        { name: "Whey Protein Nacional", price: 65.9, savings: 24.0 },
        { name: "Albumina", price: 35.9, savings: 54.0 },
      ],
    },
    {
      id: "7",
    ...
    },
    {
      ...
      checked: false,
      alternatives: [
        { name: "Leite em pó desnatado", price: 7.5, savings: 2.3 },
      ],
    },
    {
      id: "9",
    ...
    },
    {
      ...
      checked: false,
      alternatives: [
        { name: "Sardinha fresca", price: 18.9, savings: 14.0 },
        { name: "Atum em lata", price: 12.9, savings: 20.0 },
      ],
    },
    {
      id: "11",
  ...
  const categorizedItems = shoppingList.reduce(
    (acc, item) => {
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mb-6">
            Baseada na sua dieta personalizada e orçamento de R${" "}
            {budget.toFixed(2)}/mês
          </p>
                      ...
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div className="text-right">
                          <div className="text-xl font-bold">
                            R$ {store.estimatedTotal.toFixed(2)}
                          </div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-yellow-700 mt-1">
                        Você está próximo do limite. Considere as alternativas
                        para economizar.
                      </p>
                    </div>
                  </div>
              ...
              <CardContent className="space-y-3 text-sm">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Itens não perecíveis saem mais baratos em quantidade.
                  </p>
                </div>
                <div>
                  <h4 className="font-medium">Compare preços</h4>
                  <p className="text-muted-foreground">
                    Use apps como Mercado Livre ou iFood para comparar.
                  </p>
                </div>
                <div>
                  <h4 className="font-medium">Substitutos inteligentes</h4>
                  <p className="text-muted-foreground">
                    Ovo e frango podem substituir carnes mais caras.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-sm">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Prepare proteínas e carboidratos para a semana.
                  </p>
                </div>
                <div>
                  <h4 className="font-medium">Congele porções</h4>
                  <p className="text-muted-foreground">
                    Divida em marmitas individuais e congele.
                  </p>
                </div>
                <div>
                  <h4 className="font-medium">Lista de urgência</h4>
                  <p className="text-muted-foreground">
                    Sempre tenha ovos, arroz e frango de reserva.
                  </p>
                </div>
              </CardContent>
            </Card>
